...
X_train, y_train = torch.Tensor(X_train).permute(0,3,1,2), torch.Tensor(y_train).long()
...
print("=> Training")
X_batches = [X_train[:71], X_train[71:141], X_train[141:211], X_train[211:281], X_train[281:351], X_train[351:421], X_train[421:491], X_train[491:]]
y_batches = [y_train[:71], y_train[71:141], y_train[141:211], y_train[211:281], y_train[281:351], y_train[351:421], y_train[421:491], y_train[491:]]
for epoch in range(1, args.num_epochs+1):
    ...
    loss_avg = loss_sum / X_train.shape[0]
    accuracy_avg = accuracy_sum / X_train.shape[0]
...
plt.savefig("train_dev_acc_{}.png".format(args.num_epochs))
...
plt.savefig("train_dev_loss_{}.png".format(args.num_epochs))
